...
import com.example.you.Adapter.FaceAdapter;
...
public class Face extends Fragment  {
    ...
    View view;
    ArrayList<FaceModel> list = new ArrayList<>();
    ...
    private void loadFaceFromFirebase(){
        DatabaseReference myRef = database.getReference("Face");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@org.checkerframework.checker.nullness.qual.NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    FaceModel faceModel = snapshot.getValue(FaceModel.class);
                    list.add(faceModel);
                }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecycleView = view.findViewById(R.id.recycler_face);
        mRecycleView.setHasFixedSize(true);
        mManager = new LinearLayoutManager(getActivity());
        mAdapter = new FaceAdapter(list);
